...
export default function UserInfo() {
  ...
  const addBlock = async () => {
    await postRequest(`/api/admin/users/${selectedId}/block`);
    getUserInfo();
  };
  const removeBlock = async () => {
    await postRequest(`/api/admin/users/${selectedId}/unblock`);
    getUserInfo();
  };
  useEffect(() => {
    getUserInfo();
        ...
        <div className="w-full  ">
          ...
          <div className="  mt-3   bg-[#F9FAFB] ">
            <div className="mx-5">
              ...
              <div className="flex  bg-[#F9FAFB]  h-[500px] justify-between mt-7 gap-5">
                <div className="md:order-1 w-full h-[500px]  xs:order-2">
                  <Orders_Table />
                </div>
